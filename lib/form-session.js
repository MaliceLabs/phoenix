...
var guestMaxAge = Interval.parse(config.session.guestMaxAge).seconds;
var userMaxAge = Interval.parse(config.session.userMaxAge).seconds;
var maximumFormSize = ByteSize.parse(config.maximumFormSize).bytes;
